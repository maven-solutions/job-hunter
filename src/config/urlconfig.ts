// export const BASE_URL = "https://d2fa6tipx2eq6v.cloudfront.net/api/v1";
// export const VA_BASE_URL = "https://d2fa6tipx2eq6v.cloudfront.net/api/v1/va";

export const BASE_URL = "https://app.careerai.io/api/v1";
export const VA_BASE_URL = "https://app.careerai.io/api/v1/va";
